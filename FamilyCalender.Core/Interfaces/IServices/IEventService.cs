...
namespace FamilyCalender.Core.Interfaces.IServices
{
    public interface IEventService
    {
        ...
        Task<Event> CreateEventAsync(string eventTitle, string text, EventCategoryColor categoryColor, List<EventMemberDate> eventDates, int calenderId, List<int> memberId);
